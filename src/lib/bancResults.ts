...
import bancAnexoANorms from './bancAnexoANorms.json'
import bancIndexNorms from './bancIndexNorms.json'
import bancRegressionNorms from './bancRegressionNorms.json'
...
export function getBancNormGroupLabel(ageYears: string, _ageMonths: string): string {
  const years = Number.parseInt(ageYears, 10)
...
export function getBancAutoScoreBlockReason(ageYears: string, _ageMonths: string): string {
