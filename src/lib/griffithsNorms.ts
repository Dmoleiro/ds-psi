import norms0to2 from './griffiths0to2Norms.json'
import norms2to8 from './griffiths2to8Norms.json'
import type { GriffithsAgeBand, GriffithsSubscaleKey } from './griffithsResults'
