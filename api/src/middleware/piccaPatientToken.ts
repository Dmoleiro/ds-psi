...
export type PiccaPatientSessionContext = {
  sessionId: string
  patientId: string
  therapistId: string
...
declare module 'fastify' {
  interface FastifyRequest {
    piccaPatientSession?: PiccaPatientSessionContext
    piccaPatientToken?: string
  }
}
...
export async function requirePiccaPatientToken(request: FastifyRequest, reply: FastifyReply) {
  ...
  request.piccaPatientToken = rawToken
  request.piccaPatientSession = {
